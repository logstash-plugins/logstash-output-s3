## 4.4.1
  - Fix: no file or directory issue when file stealer removes the file but plugin tries to upload file when closing [#251](https://github.com/logstash-plugins/logstash-output-s3/pull/251)
